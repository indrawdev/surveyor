...
<form data-ajax="false" method="post" action="<?php echo base_url('survey/submitc1'); ?>">
	...
	<div>
		<div class="field-contain">
			...
			<select name="fs_jenis_aplikasi" id="fs_jenis_aplikasi" data-native-menu="false">
				<option>Pilih</option>
		...
		<div class="field-contain">
			...
			<input type="text" name="fs_nama_konsumen" id="fs_nama_konsumen" value="<?php echo $debitur->fs_nama_konsumen; ?>">
		</div>
		<div class="field-contain">
			<label for="fs_nama_ibukandung">Nama Ibu Kandung:</label>
			<input type="text" name="fs_nama_ibukandung" id="fs_nama_ibukandung" value="<?php echo $debitur->fs_nama_ibukandung; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
		...
		<div class="field-contain">
			...
			<input type="text" name="fs_tempat_lahir_konsumen" id="fs_tempat_lahir_konsumen" value="<?php echo $debitur->fs_tempat_lahir_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fd_tanggal_lahir_konsumen">Tanggal Lahir Konsumen:</label>
			<input type="date" name="fd_tanggal_lahir_konsumen" id="fd_tanggal_lahir_konsumen" value="<?php echo $debitur->fd_tanggal_lahir_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_status_konsumen">Status Pernikahan:</label>
			<select name="fs_status_konsumen" id="fs_status_konsumen" data-native-menu="false">
				<option>Pilih</option>
		...
		<div class="field-contain">
			...
			<select name="fs_jenis_kelamin_konsumen" id="fs_jenis_kelamin_konsumen" data-native-menu="false">
				<option>Pilih</option>
		...
		<div class="field-contain">
			...
			<select name="fs_agama_konsumen" id="fs_agama_konsumen" data-native-menu="false">
				<option>Pilih</option>
		...
		<div class="field-contain">
			...
			<select name="fs_mail_address" id="fs_mail_address" data-native-menu="false">
				<option>Pilih</option>
		...
		<div class="field-contain">
			...
			<textarea cols="40" rows="8" name="fs_alamat_konsumen" id="fs_alamat_konsumen"><?php echo $debitur->fs_alamat_konsumen; ?></textarea>
		</div>
		<div class="field-contain">
			<label for="fs_kelurahan_konsumen">Kelurahan Konsumen:</label>
			<input type="text" name="fs_kelurahan_konsumen" id="fs_kelurahan_konsumen" value="<?php echo $debitur->fs_kelurahan_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_kecamatan_konsumen">Kecamatan Konsumen:</label>
			<input type="text" name="fs_kecamatan_konsumen" id="fs_kecamatan_konsumen" value="<?php echo $debitur->fs_kecamatan_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_kota_konsumen">Kota Konsumen:</label>
			<input type="text" name="fs_kota_konsumen" id="fs_kota_konsumen" value="<?php echo $debitur->fs_kota_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_kodepos_konsumen">Kodepos Konsumen:</label>
			<input type="text" name="fs_kodepos_konsumen" id="fs_kodepos_konsumen" value="<?php echo $debitur->fs_kodepos_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_email_konsumen">Email Pribadi:</label>
			<input type="email" name="fs_email_konsumen" id="fs_email_konsumen" value="<?php echo $debitur->fs_email_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_handphone_konsumen">No Handphone Konsumen:</label>
			<input type="text" name="fs_handphone_konsumen" id="fs_handphone_konsumen" value="<?php echo $debitur->fs_handphone_konsumen; ?>" data-clear-btn="true">
		</div>
		<div class="field-contain">
			<label for="fs_telepon_konsumen">No Telepon Konsumen:</label>
			<input type="text" name="fs_telepon_konsumen" id="fs_telepon_konsumen" value="<?php echo $debitur->fs_telepon_konsumen; ?>" data-clear-btn="true">
		</div>
